...
import (
	"flag"
	"livegoServer/configure"
	"livegoServer/protocol/hls"
	"livegoServer/protocol/httpflv"
	"livegoServer/protocol/httpopera"
...
func main() {
	...
	var groups []Group
	var msg []Msg
	msg = append(msg,Msg{Id:1,Date:12315646546})
	groups = append(groups,Group{Id:1,MsgList:msg})
